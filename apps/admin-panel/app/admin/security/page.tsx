    ...
    <PermissionGate permission="security.manage">
      <div className="page-stack">
        ...
        <section className="panel-card">
          ...
          <p className="muted-copy">
            TOTP is enforced for admin-panel OTP login after it is enabled. Pilgrim and owner phone
          ...
          {totpSetup ? (
            <div className="panel warning-panel">
              ...
              <p className="muted-copy">
                Scan the following otpauth URI with your authenticator, or use the manual secret.
              </p>
        ...
        <section className="grid grid-2">
          <section className="panel warning-panel">
            ...
            <p>
              Active session listing and admin-side revocation remain available through the Sessions
              and Audit pages.
            </p>
