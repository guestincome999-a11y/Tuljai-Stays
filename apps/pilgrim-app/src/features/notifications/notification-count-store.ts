...
/**
 * Reconciles the count with the server (which counts every unread
 * notification, not just the first page the list loads). On failure the last
 * known count is kept instead of being reset to 0.
 */
